...
namespace Metrics.Json
{
    public class JsonMetricsContext
    {
        ...
        private JsonBarGauge[] bargauges = new JsonBarGauge[0];
        ...
        public JsonBarGauge[] BarGauges { get { return this.bargauges; } set { this.bargauges = value ?? new JsonBarGauge[0]; } }
        ...
        public static JsonMetricsContext FromContext(MetricsData contextData, IEnumerable<EnvironmentEntry> environment, string version)
        {
            return new JsonMetricsContext
            {
                ...
                BarGauges = contextData.BarGauges.Select(JsonBarGauge.FromBarGauge).ToArray(),
        ...
        private IEnumerable<JsonProperty> ToJsonProperties()
        {
            ...
            if (this.BarGauges.Length > 0)
            {
                yield return new JsonProperty("BarGauges", this.BarGauges.Select(g => g.ToJsonObject()));
            }
        ...
        public MetricsData ToMetricsData()
        {
            return new MetricsData(this.Context, this.Timestamp,
                    ...
                    this.BarGauges.Select(bg => bg.ToValueSource()));
        }
    }
}
